...
class AlipayPay
{
    private $plugin_id = 'alipay';// 插件唯一ID
    private $p_set = [];
    private $notify_url = '';
    private $return_url = '';
    private $dir = '';// getcwd()
    private $host = '';
    private $config= [];
    function __construct($config,$order_sn='', $order_amount='', $action='aliwap')
    {
        $this->order_sn = $order_sn;
        $this->order_amount = $order_amount;
        $this->action = $action;
        $this->config= $config;
        $this->notify_url = url('portal/pay/alipayBack','',true,true);
        $this->return_url = url('portal/pay/alipayBack','',true,true);
